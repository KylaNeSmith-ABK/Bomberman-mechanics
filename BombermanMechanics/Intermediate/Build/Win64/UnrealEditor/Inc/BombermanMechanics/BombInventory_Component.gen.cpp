...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bHasBomb_MetaData[];
#endif
		static void NewProp_bHasBomb_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bHasBomb;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb_MetaData[] = {
		{ "Category", "BombInventory_Component" },
		{ "ModuleRelativePath", "BombInventory_Component.h" },
	};
#endif
	void Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb_SetBit(void* Obj)
	{
		((UBombInventory_Component*)Obj)->bHasBomb = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb = { "bHasBomb", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBombInventory_Component), &Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBombInventory_Component_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBombInventory_Component_Statics::NewProp_bHasBomb,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BombermanMechanics_Source_BombermanMechanics_BombInventory_Component_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBombInventory_Component, UBombInventory_Component::StaticClass, TEXT("UBombInventory_Component"), &Z_Registration_Info_UClass_UBombInventory_Component, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBombInventory_Component), 1349694475U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BombermanMechanics_Source_BombermanMechanics_BombInventory_Component_h_436948376(TEXT("/Script/BombermanMechanics"),

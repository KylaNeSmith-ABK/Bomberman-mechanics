...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_EndLocationOffset_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_EndLocationOffset;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TimeToMove_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_TimeToMove;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDestructible_Component_Statics::NewProp_EndLocationOffset_MetaData[] = {
		{ "Category", "Destructible_Component" },
		{ "ModuleRelativePath", "Destructible_Component.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDestructible_Component_Statics::NewProp_EndLocationOffset = { "EndLocationOffset", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDestructible_Component, EndLocationOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UDestructible_Component_Statics::NewProp_EndLocationOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDestructible_Component_Statics::NewProp_EndLocationOffset_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDestructible_Component_Statics::NewProp_TimeToMove_MetaData[] = {
		{ "Category", "Destructible_Component" },
		{ "ModuleRelativePath", "Destructible_Component.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDestructible_Component_Statics::NewProp_TimeToMove = { "TimeToMove", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDestructible_Component, TimeToMove), METADATA_PARAMS(Z_Construct_UClass_UDestructible_Component_Statics::NewProp_TimeToMove_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDestructible_Component_Statics::NewProp_TimeToMove_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDestructible_Component_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDestructible_Component_Statics::NewProp_EndLocationOffset,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDestructible_Component_Statics::NewProp_TimeToMove,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BombermanMechanics_Source_BombermanMechanics_Destructible_Component_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDestructible_Component, UDestructible_Component::StaticClass, TEXT("UDestructible_Component"), &Z_Registration_Info_UClass_UDestructible_Component, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDestructible_Component), 108648001U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BombermanMechanics_Source_BombermanMechanics_Destructible_Component_h_2855231481(TEXT("/Script/BombermanMechanics"),

...
#define UE_PROJECT_NAME BombermanMechanics
#define UE_TARGET_NAME BombermanMechanicsEditor
#define UE_MODULE_NAME "BombermanMechanics"
...
#define BOMBERMANMECHANICS_API DLLEXPORT
